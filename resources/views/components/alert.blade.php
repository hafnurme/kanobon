<template x-if="alertVisible">

    <div class="fixed top-4 right-4 left-4">
        <div id="alert-4"
            class="flex p-4 mb-4 text-yellow-800 rounded-lg bg-yellow-50 dark:bg-gray-800 dark:text-yellow-300 border border-gray-600"
            role="alert">
            ...
            <div class="ml-3 text-sm font-medium" x-text="alertMessage">
